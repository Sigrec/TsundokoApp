...
namespace Tsundoku.Tests
{
    ...
    public class SeriesModelTests
    {
        ...
        {
            Assert.That((await Series.CreateNewSeriesCardAsync("Classroom of the Elite", Constants.Format.Novel, 14, 0, [], string.Empty, Constants.Demographic.Seinen, 4, (decimal)5.6, (decimal)5000.65)).ToString(), Is.EqualTo(await File.ReadAllTextAsync(@"\Tsundoku\Tests\SeriesModel\SeriesModelTestData\CoTE.json")));
        }
