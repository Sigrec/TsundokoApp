...
namespace Tsundoku.Models
{
    public class Constants
    {
        ...
        public static readonly List<string> ADVANCED_SEARCH_FILTERS = [.. new List<string> {"Rating==", "Rating>=", "Rating<=", "Status==Finished", "Status==Ongoing", "Status==Cancelled", "Status==Hiatus", "Format==Manga", "Format==Novel", "Demographic==Shounen", "Demographic==Shoujo", "Demographic==Seinen", "Demographic==Josei", "Demographic==Unknown", "Notes==", "Value==", "Value>=", "Value<=", "Read==", "Read>=", "Read<=", "CurVolumes==", "CurVolumes>=", "CurVolumes<=", "MaxVolumes==", "MaxVolumes>=", "MaxVolumes<=", "Series==Complete", "Series==InComplete", "Favorite==True", "Favorite==False", "Publisher==", "Genre==Action", "Genre==Adventure", "Genre==Comedy", "Genre==Drama", "Genre==Ecchi", "Genre==Fantasy", "Genre==Horror", "Genre==MahouShoujo", "Genre==Mecha", "Genre==Music", "Genre==Mystery", "Genre==Psychological", "Genre==Romance", "Genre==SciFi", "Genre==SliceOfLife", "Genre==Sports", "Genre==Supernatural", "Genre==Thriller"}.OrderBy(x => x)];
