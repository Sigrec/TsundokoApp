...
namespace Tsundoku.Models
{
    public class Constants
    {
        ...
        public static readonly List<string> ADVANCED_SEARCH_FILTERS = new List<string> {"Rating==", "Rating>=", "Rating<=", "Status==Finished", "Status==Ongoing", "Status==Cancelled", "Status==Hiatus", "Format==Manga", "Format==Novel", "Demographic==Shounen", "Demographic==Shoujo", "Demographic==Seinen", "Demographic==Josei", "Demographic==Unknown", "Notes==", "Value==", "Value>=", "Value<=", "Read==", "Read>=", "Read<=", "CurVolumes==", "CurVolumes>=", "CurVolumes<=", "MaxVolumes==", "MaxVolumes>=", "MaxVolumes<=", "Series==Complete", "Series==InComplete", "Favorite==True", "Favorite==False", "Publisher=="}.OrderBy(x => x).ToList();
		...
		public static readonly string[] AVAILABLE_COLLECTION_FILTERS = ["None", "Query", "Favorites", "Complete", "Incomplete", "Ongoing", "Finished", "Hiatus", "Cancelled", "Shounen", "Shoujo", "Seinen", "Josei", "Manga", "Novel", "Publisher", "Read", "Unread", "Rating", "Value"];
