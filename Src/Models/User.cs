...
namespace Tsundoku.Models
{
    public class User
    {
        ...
        {
            LOGGER.Info($"Saving \"{UserName}'s\" Collection Data");
            UserCollection = UserCollection;
            SavedThemes.Remove(TsundokuTheme.DEFAULT_THEME);
            File.WriteAllText(USER_DATA_FILEPATH, JsonSerializer.Serialize(this, typeof(User), UserJsonModel));
        }
        ...
        public bool UpdateVersion(JsonNode userData, bool isImport=false, bool updatedCovers=false)
        {
